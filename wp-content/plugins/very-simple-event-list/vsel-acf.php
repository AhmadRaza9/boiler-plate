					...
					if ( $values && !empty($values) ) {
						...
						$output .= '<div class="vsel-meta-acf-'.$field['name'].'">';
							if ( $field['type'] == 'textarea' ) {
								...
								$output .= '<span class="acf-field-name">'.sprintf(esc_attr($acf_label), '</span><span class="acf-field-value"><a href="'.esc_url($acf_value).'" target="_blank" rel="noreferrer noopener">'.esc_attr($acf_value).'</a></span>' );
