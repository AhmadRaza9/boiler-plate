...
function vsel_field_callback_92() {
	...
	$value = esc_attr( get_option( 'vsel-setting-92' ) );
	?>
	<input type='text' size='40' maxlength='10' name='vsel-setting-92' placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>' />
	<?php
}
...
function vsel_field_callback_87() {
	$value = esc_attr( get_option( 'vsel-setting-87' ) );
	?>
	<input type='hidden' name='vsel-setting-87' value='no'>
	<label><input type='checkbox' name='vsel-setting-87' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'One time field instead of start time and end time.', 'very-simple-event-list' ); ?></label>
...
function vsel_field_callback_88() {
	$placeholder = esc_attr( '-' );
	$value = esc_attr( get_option( 'vsel-setting-88' ) );
	?>
	<input type='text' size='40' maxlength='10' name='vsel-setting-88' placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>' />
	<?php
}
...
function vsel_field_callback_61() {
	...
	<label><input type='checkbox' name='vsel-setting-61' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Disable column in dashboard.', 'very-simple-event-list' ); ?></label>
...
function vsel_field_callback_50() {
	...
	<label><input type='checkbox' name='vsel-setting-50' <?php checked( $value, 'yes' ); ?> value='yes'> <?php printf( esc_attr__( 'Disable support for the %s page.', 'very-simple-event-list' ), esc_attr__( 'Menu', 'very-simple-event-list' ) ); ?></label>
...
function vsel_field_callback_60() {
	...
	<label><input type='checkbox' name='vsel-setting-60' <?php checked( $value, 'yes' ); ?> value='yes'> <?php printf( esc_attr__( 'Disable support for the %s page.', 'very-simple-event-list' ), esc_attr__( 'Single event', 'very-simple-event-list' ) ); ?></label>
	<?php
}
...
function vsel_field_callback_48() {
	...
	<label><input type='checkbox' name='vsel-setting-48' <?php checked( $value, 'yes' ); ?> value='yes'> <?php printf( esc_attr__( 'Disable support for the %s page.', 'very-simple-event-list' ), esc_attr__( 'Post type archive', 'very-simple-event-list' ) ); ?></label>
	<p><strong><i><?php printf( esc_attr__( 'Resave the %s after changing this.', 'very-simple-event-list' ), $link_permalinks ); ?></i></strong></p>
	<p><i><?php printf( esc_attr__( 'The %s page is not generated by VSEL. Events are not ordered by event date.', 'very-simple-event-list' ), esc_attr__( 'Post type archive', 'very-simple-event-list' ) ); ?></i></p>
	<p><i><?php esc_attr_e( 'This support is added to make VSEL compatible with page builder plugins.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_40() {
	...
	<p><i><?php printf( esc_attr__( 'The %s page is not generated by VSEL. Events are not ordered by event date.', 'very-simple-event-list' ), esc_attr__( 'Event category', 'very-simple-event-list' ) ); ?></i></p>
	<p><i><?php esc_attr_e( 'This support is added to make VSEL compatible with page builder plugins.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_41() {
	...
	<p><i><?php printf( esc_attr__( 'The %s page is not generated by VSEL. Events are not ordered by event date.', 'very-simple-event-list' ), esc_attr__( 'Search results', 'very-simple-event-list' ) ); ?></i></p>
	<p><i><?php esc_attr_e( 'This support is added to make VSEL compatible with page builder plugins.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_49() {
	...
	<label><input type='checkbox' name='vsel-setting-49' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Activate iCal feed.', 'very-simple-event-list' ); ?></label>
	<?php
	$link_label = __( 'Permalinks', 'very-simple-event-list' );
	$link_permalinks = '<a href="'.admin_url( 'options-permalink.php' ).'">'.$link_label.'</a>';
	?>
...
function vsel_field_callback_93() {
	$value = esc_attr( get_option( 'vsel-setting-93' ) );
	$placeholder = '10';
	?>
	<label><input type='number' size='10' min='5' max='100' maxlength='3' name='vsel-setting-93' placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>' /> <?php printf( esc_attr__( 'Default value is %s.', 'very-simple-event-list' ), '10' ); ?></label>
...
function vsel_field_callback_66() {
	...
	$placeholder = '36';
	?>
	<label><input type='number' size='10' min='20' max='60' maxlength='3' name='vsel-setting-66' placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>' /> <?php printf( esc_attr__( 'Default value is %s.', 'very-simple-event-list' ), '36' ); ?></label>
...
function vsel_field_callback_35() {
	...
	<?php printf( esc_attr__( 'Default value is %s.', 'very-simple-event-list' ), esc_attr__( 'Align left', 'very-simple-event-list' ) ); ?>
	<p><i><?php esc_attr_e( 'Section is full width when Event info and Featured image are hidden.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_59() {
	...
	<label><input type='checkbox' name='vsel-setting-59' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Display on top (outside Event details section).', 'very-simple-event-list' ); ?></label>
...
function vsel_field_callback_62() {
	...
	<label><input type='checkbox' name='vsel-setting-62' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Show a date icon instead of a label.', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_68() {
	...
	<label><input type='checkbox' name='vsel-setting-68' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Combine date icon and title.', 'very-simple-event-list' ); ?></label>
...
function vsel_field_callback_36() {
	...
	<?php printf( esc_attr__( 'Default value is %s.', 'very-simple-event-list' ), esc_attr__( 'Align right', 'very-simple-event-list' ) ); ?>
	<p><i><?php esc_attr_e( 'This only affects pages where you have added the shortcode.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_13() {
	...
	<label><input type='checkbox' name='vsel-setting-13' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Show a summary instead of all event info.', 'very-simple-event-list' ); ?></label>
	<p><i><?php esc_attr_e( 'This only affects pages where you have added the shortcode.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_64() {
	...
	<label><input type='checkbox' name='vsel-setting-64' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Hide', 'very-simple-event-list' ); ?></label>
	<p><i><?php esc_attr_e( 'This only affects pages where you have added the shortcode.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_16() {
	...
	<p><i><?php printf( esc_attr__( 'Use %1$s to display the %2$s variable.', 'very-simple-event-list' ), '%s', esc_attr__( 'Date', 'very-simple-event-list' ) ); ?></i></p>
	<?php
}
...
function vsel_field_callback_17() {
	...
	<p><i><?php printf( esc_attr__( 'Use %1$s to display the %2$s variable.', 'very-simple-event-list' ), '%s', esc_attr__( 'Start date', 'very-simple-event-list' ) ); ?></i></p>
	<?php
}
...
function vsel_field_callback_18() {
	...
	<p><i><?php printf( esc_attr__( 'Use %1$s to display the %2$s variable.', 'very-simple-event-list' ), '%s', esc_attr__( 'End date', 'very-simple-event-list' ) ); ?></i></p>
	<?php
}
...
function vsel_field_callback_19() {
	...
	<p><i><?php printf( esc_attr__( 'Use %1$s to display the %2$s variable.', 'very-simple-event-list' ), '%s', esc_attr__( 'Time', 'very-simple-event-list' ) ); ?></i></p>
	<?php
}

function vsel_field_callback_89() {
	$placeholder = esc_attr__( 'All-day event', 'very-simple-event-list' );
	$value = esc_attr( get_option( 'vsel-setting-89' ) );
	?>
	<input type='text' size='40' name='vsel-setting-89' placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>' />
	<?php
}
...
function vsel_field_callback_20() {
	...
	<p><i><?php printf( esc_attr__( 'Use %1$s to display the %2$s variable.', 'very-simple-event-list' ), '%s', esc_attr__( 'Location', 'very-simple-event-list' ) ); ?></i></p>
	<?php
}
...
function vsel_field_callback_63() {
	...
	<label><input type='checkbox' name='vsel-setting-63' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Show a date icon instead of a label.', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_67() {
	...
	<label><input type='checkbox' name='vsel-setting-67' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Combine date icon and title.', 'very-simple-event-list' ); ?></label>
	<p><strong><i><?php esc_attr_e( 'Date icon must be active.', 'very-simple-event-list' ); ?></i></strong></p>
	<p><strong><i><?php esc_attr_e( 'Title and date must not be hidden.', 'very-simple-event-list' ); ?></i></strong></p>
	<?php
}
...
function vsel_field_callback_1() {
	...
	<label><input type='checkbox' name='vsel-setting-1' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Show a summary instead of all event info.', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_65() {
	...
	<label><input type='checkbox' name='vsel-setting-65' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Hide', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_90() {
	$placeholder = esc_attr__( 'All-day event', 'very-simple-event-list' );
	$value = esc_attr( get_option( 'vsel-setting-90' ) );
	?>
	<input type='text' size='40' name='vsel-setting-90' placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>' />
	<?php
}
...
function vsel_field_callback_71() {
	...
	$placeholder = '36';
	?>
	<label><input type='number' size='10' min='20' max='60' maxlength='3' name='vsel-setting-71' placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>' /> <?php printf( esc_attr__( 'Default value is %s.', 'very-simple-event-list' ), '36' ); ?></label>
	<p><i><?php esc_attr_e( 'This is the width of the Event details section.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_74() {
	...
	<label><input type='checkbox' name='vsel-setting-74' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Show a date icon instead of a label.', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_75() {
	...
	<label><input type='checkbox' name='vsel-setting-75' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Combine start date and end date in one label.', 'very-simple-event-list' ); ?></label>
	<p><i><?php esc_attr_e( 'This does not affect the date icons.', 'very-simple-event-list' ); ?></i></p>
	<?php
}
...
function vsel_field_callback_73() {
	...
	<label><input type='checkbox' name='vsel-setting-73' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Link to the category page.', 'very-simple-event-list' ); ?></label>
	<p><i><?php printf( esc_attr__( 'The %s page is not generated by VSEL. Events are not ordered by event date.', 'very-simple-event-list' ), esc_attr__( 'Event category', 'very-simple-event-list' ) ); ?></i></p>
	<?php
}
...
function vsel_field_callback_86() {
	...
	<label><input type='checkbox' name='vsel-setting-86' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Hide', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_76() {
	...
	<label><input type='checkbox' name='vsel-setting-76' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Hide', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_77() {
	...
	<label><input type='checkbox' name='vsel-setting-77' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Hide', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_78() {
	...
	<label><input type='checkbox' name='vsel-setting-78' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Hide', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_79() {
	...
	<label><input type='checkbox' name='vsel-setting-79' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Hide', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_80() {
	...
	<label><input type='checkbox' name='vsel-setting-80' <?php checked( $value, 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Hide', 'very-simple-event-list' ); ?></label>
	<?php
}
...
function vsel_field_callback_91() {
	$placeholder = esc_attr__( 'All-day event', 'very-simple-event-list' );
	$value = esc_attr( get_option( 'vsel-setting-91' ) );
	?>
	<input type='text' size='40' name='vsel-setting-91' placeholder='<?php echo $placeholder; ?>' value='<?php echo $value; ?>' />
	<?php
}
...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		...
		<a href="?page=vsel&tab=single_options" class="nav-tab <?php echo $active_tab == 'single_options' ? 'nav-tab-active' : ''; ?>"><?php esc_attr_e( 'Single event', 'very-simple-event-list' ); ?></a>
	</h2>
